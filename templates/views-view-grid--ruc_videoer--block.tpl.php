...
<div class="grid gallery">
  <div class="item text">
    <div class="inner">
      <h2>Tester</h2>
      <p>Min relativt lange tekst, som bare fortsætter indtil pladsen er løbet
        helt ud. Det aner vi ikke hvornår det er, men mon ikke det er snart? Hm,
        det er slet ikke endnu. Der er endnu plads nok. Så skriv bare
        hertil.</p>
      <?php if ($is_front): ?>
